...
const Footer = () => {
  return (
    <div className='bg-[#2699fb] w-full'>
      ...
      <div>
        <h1 className='w-full text-3xl font-bold text-black'>Transacto</h1>
        <p className='py-4'>Transacto: Your all-in-one payment solution. Seamlessly send, receive, and manage transactions with ease. Enjoy secure transactions, customizable plans, and expert support for your business needs. Join Transacto today!</p>
